...
- このテナント設定は、2021年9月30日以降、順次自動インストール機能が追加されている。
- この設定を「有効」にした組織では、2021年11月から自動インストールが開始される。
...
2021年9月30日以降順次、「Install Power BI app for Microsoft Teams automatically tenant」の設定が追加されており、Power BI 管理者は、ここから自動インストールの有効・無効を設定することができます。
