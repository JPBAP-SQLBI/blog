...
Update: 2022/2/28</br>
2022年2月23日以降、Power BI サービスでクラシックワークスペースの作成ができなくなりました。
...
| クラシックワークスペースの作成機能の提供終了                         | クラシックワークスペース作成機能が終了しました。また今後テナント設定の"クラシックワークスペースの作成のブロック"の設定もPower BI 管理ポータルから削除される予定です   | 2022年2月~  | 
