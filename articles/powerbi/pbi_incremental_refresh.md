...
1つ目の条件　=　“次より後” 　（RnageStart）
2つ目の条件 =  “次の値以前” （RnageEnd）
or
1つ目の条件　=　“次の値以降” （RnageStart）
2つ目の条件 =  “次より前” 　（RnageEnd）
...
「アーカイブの開始」とは、どれくらいのデータを保持するかの指定で、「増分更新データを開始する●●」どれくらいの期間を定期更新するかの指定です。
